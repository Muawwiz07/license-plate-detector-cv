...
- **Link:** [universe.roboflow.com](https://universe.roboflow.com)
- **Total Images:** 9,572 labeled license plate images
- **Task Type:** Object Detection
- **Usage:** Sample images from this dataset are used for testing in the `images/` folder

---

## 📓 Google Colab Notebook

Test this project directly in your browser — no installation needed!

[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/)

1. Open [colab.research.google.com](https://colab.research.google.com)
2. Upload `License_Plate_Detection.ipynb`
3. Run cells one by one ▶️
4. Upload any license plate image and see results instantly!
